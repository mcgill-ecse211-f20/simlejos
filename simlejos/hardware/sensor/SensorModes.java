...
/**
 * Provides access to the modes supported by a sensor.
 * 
 * @author andy
 */
public interface SensorModes extends SensorMode {
  /**
   * Returns a list of string descriptions for the sensors available modes.
   * 
  ...
  /**
   * Returns the sample provider interface for the requested mode.
   * 
  ...
  /**
   * Returns the sample provider for the request mode.
   * 
   ...
   * 
   * @param mode the index number of the mode. Index number corresponds with the item order of 
   *     the list from getAvailableModes().
   */
   ...
   * Sets the current mode for fetching samples.
   * 
   * @param modeName the name of the mode. name corresponds with the item value of the list from
   *     getAvailableModes().
   */
   ...
   * 
   * @return the index number of the mode. Index number corresponds with the item order of the
   *     list from getAvailableModes().
   */
